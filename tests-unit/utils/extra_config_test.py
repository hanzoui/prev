...
def test_load_extra_model_paths_expands_appdata(
    ...
    if sys.platform == "win32":
        expected_base_path = 'C:/Users/TestUser/AppData/Roaming/HanzoStudio'
    else:
        expected_base_path = '/Users/TestUser/AppData/Roaming/HanzoStudio'
    expected_calls = [
